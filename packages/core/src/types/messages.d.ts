 ...
 */
export type Message = SubmitJobMessage | RequestJobStatusMessage | RegisterWorkerMessage | UpdateJobProgressMessage | CompleteJobMessage | FailJobMessage | ClaimJobMessage | WorkerHeartbeatMessage | WorkerStatusMessage | JobAcceptedMessage | ResponseJobStatusMessage | JobAssignedMessage | JobAvailableMessage | JobCompletedMessage | WorkerRegisteredMessage | ConnectionEstablishedMessage | ErrorMessage | SubscribeStatsMessage | RequestStatsMessage | ResponseStatsMessage | StatsBroadcastMessage | SubscribeJobMessage | SubscribeJobNotificationsMessage | SubscriptionConfirmedMessage | JobNotificationsSubscribedMessage | ServiceRequestMessage | ConnectorWSStatusMessage | AckMessage | UnknownMessage | JobUpdateMessage;
/**
 * Type guard to check if a message is of a specific type
 */
export declare function isMessageType<T extends Message>(message: Message, type: MessageType): message is T;
/**
