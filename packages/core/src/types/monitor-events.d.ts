...
export type SubscriptionTopic = 'workers' | 'jobs' | 'jobs:progress' | 'jobs:status' | 'system_stats' | 'heartbeat';
...
export type MonitorEvent = WorkerConnectedEvent | WorkerDisconnectedEvent | WorkerStatusChangedEvent | JobSubmittedEvent | JobAssignedEvent | JobStatusChangedEvent | JobProgressEvent | JobCompletedEvent | JobFailedEvent | MonitorConnectEvent | SubscribeEvent | ResyncRequestEvent | ResyncResponseEvent | FullStateSnapshotEvent | HeartbeatEvent | HeartbeatAckEvent | SystemStatsEvent;
...
//# sourceMappingURL=monitor-events.d.ts.map