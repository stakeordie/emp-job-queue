import { ConnectionManagerInterface, WebSocketConnection, ConnectionManagerConfig } from './interfaces/connection-manager.js';
...
export declare class ConnectionManager implements ConnectionManagerInterface {
    ...
    handleChunkedMessage(_connectionId: string, chunk: ChunkedMessageChunk): Promise<BaseMessage | null>;
