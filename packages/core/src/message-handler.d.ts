...
import { BaseMessage, MessageType, JobSubmissionMessage, JobProgressMessage, JobCompletedMessage, JobFailedMessage, WorkerRegistrationMessage, WorkerStatusMessage, WorkerHeartbeatMessage, ServiceRequestMessage, CompleteJobMessage, CancelJobMessage, FailJobMessage } from './types/messages.js';
export declare class MessageHandler implements MessageHandlerInterface {
    ...
    constructor(redisService: RedisServiceInterface, connectionManager: ConnectionManagerInterface, eventBroadcaster?: EventBroadcaster);
