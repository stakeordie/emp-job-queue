...
export class ComfyUILogInterpreter extends BaseLogInterpreter {
    ...
    this.registerPattern(
      createCustomPattern(
        ...
        (match: RegExpMatchArray | string, context?: LogContext) => ({
          ...
          category: 'validation' as const,
          suggestedAction:
            'Verify your workflow file and ensure it was exported correctly from ComfyUI',
          retryRecommended: false,
        ...
        (match: RegExpMatchArray | string, context?: LogContext) => {
          ...
          return {
            ...
            progressImpact: {
              shouldUpdateProgress: true,
              newProgressPercent:
                extractedPercent || Math.min((context?.progressPercent || 20) + 5, 80),
            },
          };
        },
        0.7
   ...
   */
  async interpretWebSocketMessage(
    message: any,
    context?: LogContext
   ...
   */
  private interpretStructuredMessage(
    message: any,
    context?: LogContext
