...
export const MachineEnvInterface = {
  ...
  required: {
    ...
    "WORKER_BUNDLE_MODE":"COMFYUI_WORKER_BUNDLE_MODE"
  },
  ...
  optional: {
    ...
    "WORKER_COMFYUI_REMOTE_API_KEY": "WORKER_COMFYUI_REMOTE_API_KEY",
    "WORKER_COMFYUI_REMOTE_SECURE": "WORKER_COMFYUI_REMOTE_SECURE",
    "WORKER_COMFYUI_REMOTE_TIMEOUT_SECONDS": "WORKER_COMFYUI_REMOTE_TIMEOUT_SECONDS",
    "WORKER_COMFYUI_REMOTE_MAX_CONCURRENT_JOBS": "WORKER_COMFYUI_REMOTE_MAX_CONCURRENT_JOBS",
  },
  ...
  defaults: {
    ...
    "WORKER_WEBSOCKET_AUTH_TOKEN": "123",
    "WORKER_COMFYUI_REMOTE_API_KEY":"",
    "WORKER_COMFYUI_REMOTE_SECURE":""
