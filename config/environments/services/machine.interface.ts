...
export const MachineEnvInterface = {
  ...
  required: {
    ...
    "OLLAMA_PORT_INCREMENT":"OLLAMA_PORT_INCREMENT",
    "OLLAMA_INSTANCES_PER_GPU":"OLLAMA_INSTANCES_PER_GPU",
    "OLLAMA_MAX_CONCURRENT_JOBS":"OLLAMA_MAX_CONCURRENT_JOBS",
    "OLLAMA_GPU_MEMORY_FRACTION":"OLLAMA_GPU_MEMORY_FRACTION",
    "OLLAMA_MAX_LOADED_MODELS":"OLLAMA_MAX_LOADED_MODELS",
    "OLLAMA_TIMEOUT_SECONDS":"OLLAMA_TIMEOUT_SECONDS",
    "OLLAMA_RETRY_ATTEMPTS":"OLLAMA_RETRY_ATTEMPTS",
    "OLLAMA_REQUEST_TIMEOUT_MS":"OLLAMA_REQUEST_TIMEOUT_MS",
    "OLLAMA_INSTALL_TIMEOUT":"OLLAMA_INSTALL_TIMEOUT",
    "OLLAMA_MODEL_DOWNLOAD_TIMEOUT":"OLLAMA_MODEL_DOWNLOAD_TIMEOUT",
