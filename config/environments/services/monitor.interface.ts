...
export const MonitorEnvInterface = {
  ...
  optional: {
    ...
    "NEXT_PUBLIC_DEFAULT_WS_URL": "REDIS-API_WEBSOCKET_URL",

    "NEXT_PUBLIC_WS_RETRY_MODE":"MONITOR_RETRY",
    "NEXT_PUBLIC_WS_MAX_RETRY_ATTEMPTS":"MONITOR_RETRY_ATTEMPTS",
    "NEXT_PUBLIC_WS_RETRY_DELAY":"MONITOR_RETRY_DELAY",
